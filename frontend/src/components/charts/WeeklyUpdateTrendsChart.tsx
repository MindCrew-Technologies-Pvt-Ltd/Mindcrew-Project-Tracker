      ...
      <AreaChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
        <defs>
          <linearGradient id="weeklyGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#4D7C5A" stopOpacity={0.18} />
            <stop offset="95%" stopColor="#4D7C5A" stopOpacity={0} />
          </linearGradient>
        </defs>
        <CartesianGrid strokeDasharray="3 3" stroke="#E7E8DD" vertical={false} />
        <XAxis dataKey="week" tick={{ fontSize: 11, fill: '#5F6570' }} axisLine={false} tickLine={false} />
        ...
        <Area
          ...
          strokeWidth={2.5}
          fill="url(#weeklyGrad)"
          dot={{ r: 4, fill: '#4D7C5A', stroke: '#fff', strokeWidth: 2 }}
          activeDot={{ r: 6, fill: '#0A2947', stroke: '#fff', strokeWidth: 2 }}
        />
      </AreaChart>
    </ResponsiveContainer>
  </Box>
