...
const timesheetService = {
  ...
  updateSettings: (payload: { weeklyTargetHours?: number; reminderEnabled?: boolean; reminderDay?: number; reminderHour?: number; timezone?: string; manualEntryEnabled?: boolean; workdayStartHour?: number; disableTimeLock?: boolean; disableLeaveLock?: boolean }) =>
