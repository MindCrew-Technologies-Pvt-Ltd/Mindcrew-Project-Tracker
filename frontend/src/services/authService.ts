...
const authService = {
  ...
  updateProfile: (payload: { name?: string; phone?: string; department?: string; designation?: string; employeeId?: string; jobRoles?: string[]; managerEmployeeIds?: string[] }) => axiosInstance.put('/auth/profile', payload),
};
