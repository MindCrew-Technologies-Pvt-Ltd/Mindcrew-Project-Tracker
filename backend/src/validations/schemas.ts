...
const JOB_ROLE_VALUES = ['Developer', 'Manager', 'HR', 'Sales Team', 'Data Entry', 'QA', 'Admin', 'Digital Marketing'] as const;
...
export const createLeaveRequestSchema = Joi.object({
  type: Joi.string().valid('FULL_DAY', 'HALF_DAY', 'WFH', 'COMP_OFF', 'SHORT_LEAVE').required(),
...
export const timesheetSettingsSchema = Joi.object({
  ...
  disableLeaveLock: Joi.boolean().optional(),
});
